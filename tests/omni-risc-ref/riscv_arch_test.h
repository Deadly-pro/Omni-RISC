# riscv_arch_test.h — Omni-RISC variant
# Same as the ACT env header but WITHOUT sail_macros.h, so the DUT/reference
# RVMODEL_* macros in rvmodel_macros.h are not overridden by Sail's tohost
# versions. Included before tests/env/riscv_arch_test.h via -I ordering.
